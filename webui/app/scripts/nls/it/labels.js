define({
    ...
    "sms" : {
        ...
        "DepositConf" : "Hai ricevuto {0}mBTC{1}.",
        "DepositConfSndr" : "Hai ricevuto {0}mBTC{1} da {2}.",
        "DepositConfSndrMsg" : "Hai ricevuto {0}mBTC{1} da {2} for \"{3}\".",
        "Balance" : "Il tuo saldo attuale è: {0}mBTC{1} {2}",
        "BalanceInst" : "\r\nReply ADDR, for Bitcoin address",
        "WithdrawalReq" : "Confermi l''invio {0}mBTC{1} dal tuo account a {2}?",
        ...
        "WithdrawalConf" : "Sono stati trasferiti {0}mBTC{1} dal tuo account a {2}.",
