...
define({
    ...
    "sms" : {
        ...
        "DepositConf" : "Vous avez reçu {0}mBTC{1}",
        "DepositConfSndr" : "Vous avez reçu {0}mBTC{1} from {2}",
        "DepositConfSndrMsg" : "Vous avez reçu {0}mBTC{1} from {2} for \"{3}\"",
        "Balance" : "Solde disponible: {0}mBTC{1} {2}",
        "BalanceInst" : "\r\nReply ADDR, for Bitcoin address",
        "WithdrawalReq" : "Envoyer {0}mBTC{1} à {2}?",
        ...
        "WithdrawalConf" : "Transféré {0}mBTC{1} à {2}.",
        "Help" : "ENVOYER limite: 12mBTC before PIN setup\r\nADDR - Bitcoin deposit address\r\nBAL - see available balance\r\nPIN - setup PIN\r\n{0}",
