define({
    ...
    "commands" : {
        "SignupCmd" : ["signup"],
        "HelpCmd" : ["help","hlp"],
        "DepositReqCmd" : ["address","addr","deposit","adr"],
        "BalanceCmd" : ["balance","bal","blance","balnce"],
        "TransactionsCmd" : ["transactions","txns","trans","tran"],
        "WithdrawalReqCmd" : ["send","snd", "sending","sent"],
        "VoiceCmd" : ["pin"],
        "ChargeCmd" : ["charge","req","request"],
        "ProductCmd" : ["product","prod"],
        "PayCmd" : ["pay"],
        "PriceCmd" : ["price"],
        "SellCmd" : ["sell"],
        "BuyCmd" : ["buy"]
